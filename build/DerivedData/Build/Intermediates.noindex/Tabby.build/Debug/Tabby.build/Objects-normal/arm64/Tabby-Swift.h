...
#ifndef TABBY_SWIFT_H
#define TABBY_SWIFT_H
...
SWIFT_CLASS("_TtC5Tabby11AppDelegate")
...
SWIFT_CLASS("_TtC5Tabby23DraggableStatusItemView")
@interface DraggableStatusItemView : NSView
...
@class NSWindow;
SWIFT_CLASS("_TtC5Tabby24FirstRunWindowController")
@interface FirstRunWindowController : NSWindowController <NSWindowDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
